<?php
  ...
  $gp_id=$_REQUEST["gp_id"];
   $EmpID=EDV($gp_id,2);
  //echo $sql="SELECT `gs`.*,`E_GP`.`gp_id`,`E_GP`.`type_of_site`,`E_GP`.`Id` as `earthing_Id` FROM `earthing_gp` `E_GP` left join `gp_site` `gs` ON `E_GP`.`gp_id`=`gs`.`gp_id` WHERE `gs`.`gp_id`='$EmpID'";
          ...
          <div class="row mt-4">
            <div class="col-md-12">
              ...
              <nav class="navbar navbar-light bg-light">
                <a class="btn btn-warning text-black" href="PFC.php?PageName=view_earthing_gp" style="margin:7px;font-size:large;height:37px;padding:6px;width:100px;float:right;margin-top:3px;margin-right:-473px;" role="button">Back</a>&nbsp;&nbsp;
                <h2 class="card-title" style="color:#012970;margin-right:644px;"><b>VIEW GP SITE DETAILS</b></h2>
                 </nav><br><br>
                <div class="card-body">
                  <Form method="POST">    
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-12">
                                ...
                                <select  class="typeofsite form-control"  name="typeofsite" id="typeofsite" onchange="type_of_site_val()"  disabled>
                                  ...
                                  {
                                ?>
                                <option value="<?php echo $row["Id"];?>" <?php if($row_gp["type_of_site"]==$row["Id"]){ echo 'selected'; }?>><?php echo $row["type_of_site"];?></option>
                             <?php } ?>
                                </select>
                            </div>
                      </div>                     
      ...
      <div class="container-fluid px-4">
          <div class="row mt-4">
            <div class="col-md-12">
              <div class="card-header"> 
              <nav class="navbar navbar-light bg-light">
                <h2 class="card-title" style="color:#012970;margin-left:611px;"><b>VIEW HO-SITE DETAILS</b></h2>
                 </nav><br><br>
                <div class="card-body">
                  <Form method="POST">    
                      <input type="hidden" name="roleid"   id="roleid"   value="<?php echo $_SESSION["role_Id"];?>"/>
      ...
      <div class="container-fluid px-4">
          <div class="row mt-4">
            <div class="col-md-12">
              <div class="card-header"> 
              <nav class="navbar navbar-light bg-light">
                <h2 class="card-title" style="color:#012970;margin-left:607px;"><b>VIEW GP-SITE DETAILS</b></h2>
                 </nav><br><br>
                <div class="card-body">
                  <Form method="POST">    
                      <input type="hidden" name="roleid"   id="roleid"   value="<?php echo $_SESSION["role_Id"];?>"/>
                     ...
                     <div class="form-group">
                      ...
                      <div class="row">
                        <div class="col-6">
                          ...
                          <span class="error">*<?php echo $nameErr;?></span>
                          <input type="text" class="UniqueCode form-control" name="UniqueCode" id="UniqueCode" value="<?php echo $row_gp["UniqueCode"];?>" readonly>
                        ...
                        <div class="col-6">
                          ...
                          <span class="error">* <?php echo $nameErr;?></span>
                          <input type="text" class="GoLive form-control" name="GoLive" id="GoLive" VALUE="<?php echo $row_gp["Go-Live"];?>" readonly>
                        </div>
                       ...
                       <div class="row g-3">
                            <div class="col-4">
                                ...
                                <span  class="error">* <?php echo $emailErr;?></span>
                                <input type="text" class="GPCode form-control" name="GPCode" id="GPCode" VALUE="<?php echo $row_gp["GPCode"];?>" readonly>
                            </div>
                            <div class="col-4">
                                <label for="GPLGDCode" class="form-label">GP LGD Code</span></label>
                                <span class="error">* <?php echo $phoneErr;?></span>
                                <input type="text" class="GPLGDCode form-control" name="GPLGDCode" id="GPLGDCode" VALUE="<?php echo $row_gp["GPLGDCode"];?>" readonly>
                            </div>
                            <div class="col-4">
                                <label for="GPID" class="form-label">GP ID</label>
                                <span class="error">*<?php echo $alternateErr;?></span>
                                <input type="text"  class="GPID form-control"  name="GPID" id="GPID" VALUE="<?php echo $row_gp["GPID"];?>" readonly>
                            </div>
                        </div>
                        <br>
                        <div class="row g-3">
                          <div class="col-4">
                            ...
                            <span class="error">* <?php echo $desigantionErr;?></span>
                            <input type="text"  class="TypeOfSite form-control"  name="TypeOfSite" id="TypeOfSite" VALUE="<?php echo $row_gp["TypeOfSite"];?>" readonly>
                        </div>
                        <div class="col-4">
                            <label for="Zone" class="form-label">Zone</span> </label>
                            <span class="error">* <?php echo $departmentErr;?></span>
                              <input type="text" class="Zone form-control" name="Zone" id="Zone" VALUE="<?php echo $row_gp["Zone"];?>" readonly>
                           </div>
                           <div class="col-4">
                            <label for="District" class="form-label">District</label>
                            <span class="error">* <?php echo $fatherErr;?></span>
                            <input type="text" class="District form-control" name="District" id="District" VALUE="<?php echo $row_gp["District"];?>" readonly>
                        </div>
                        </div><br>
                        <div class="row g-3">
                          <div class="col-4">
                            ...
                            <span class="error">* <?php echo $desigantionErr;?></span>
                            <input type="text"  class="PS form-control"  name="PS" id="PS" VALUE="<?php echo $row_gp["PS"];?>" readonly>
                        </div>
                        <div class="col-4">
                            <label for="NewPSName" class="form-label">New PS Name</span> </label>
                            <span class="error">* <?php echo $departmentErr;?></span>
                              <input type="text" class="NewPSName form-control" name="NewPSName" id="NewPSName" VALUE="<?php echo $row_gp["NewPSName"];?>" readonly>
                           </div>
                           <div class="col-4">
                            <label for="GP" class="form-label">GP</label>
                            <span class="error">* <?php echo $fatherErr;?></span>
                            <input type="text" class="GP form-control" name="GP" id="GP" VALUE="<?php echo $row_gp["GP"];?>" readonly>
                        </div>
</div><br/><br/>
                        <div class="row g-3">
                          <div class="col-4">
                            ...
                            <span class="error">* <?php echo $desigantionErr;?></span>
                            <input type="text"  class="TypeOfConnectivity form-control"  name="TypeOfConnectivity" id="TypeOfConnectivity" VALUE="<?php echo $row_gp["TypeOfConnectivity"];?>" readonly>
                        </div>
                          <div class="col-4">
                            <label for="Status" class="form-label">Status</span> </label>
                            <span class="error">* <?php echo $desigantionErr;?></span>
